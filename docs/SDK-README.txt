...
* Linux: Linux-x86-64
* Windows: Win64
* Windows ARM: Win-arm64ec - on ARM64 machines, this folder will be checked first, and if not found, the Win64 folder will be used as fallback
...
* Windows ARM: x264_encoder_plugin.dvcp.bundle/Contents/Win-arm64ec/x264_encoder_plugin.dvcp
